...
<div style="padding:10px 10px 10px 10px">
	<form id="itemeEditForm" class="itemForm" method="post">
	    ...
	    <table cellpadding="5">
	        ...
	        <tr>
	            <td>商品卖点:</td>
	            <td><input class="easyui-textbox" name="sell_point" data-options="multiline:true,validType:'length[0,150]'" style="height:60px;width: 280px;"></input></td>
	        </tr>
	        <tr>
	            <td>商品价格:</td>
...
<script type="text/javascript">
	...
	$(function(){
		//实例化编辑器
		itemEditEditor = KindEditorUtil.createEditor("#itemeEditForm [name=item_desc]");
	});
